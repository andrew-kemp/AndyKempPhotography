    ...
    <nav class="main-navigation" id="main-nav">
        <div class="nav-container">
            ...
            <div class="header-social-media">
                <?php 
                // Custom tooltip messages for each platform
                $tooltips = array(
                    'instagram' => 'Connect with me on Instagram',
                    'flickr' => 'Follow me on Flickr',
                    'youtube' => 'Subscribe to my YouTube',
                    'facebook' => 'Follow me on Facebook',
                    'twitter' => 'Follow me on X (Twitter)',
                    'linkedin' => 'Connect with me on LinkedIn',
                    'pinterest' => 'Follow me on Pinterest',
                    'behance' => 'View my work on Behance',
                    'vimeo' => 'Watch my videos on Vimeo'
                );
                
                foreach ($social_links as $network => $data) : 
                    $tooltip = isset($tooltips[$network]) ? $tooltips[$network] : 'Follow me on ' . $data['label'];
                ?>
