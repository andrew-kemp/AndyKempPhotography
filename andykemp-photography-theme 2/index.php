...
<!-- Hero Description Text (starts below hero, floats up on scroll) -->
<section class="hero-description-section" id="hero-description-section">
    <div class="container">
        <div class="hero-description-content">
            <p>Capturing landscapes, aviation heritage, nature motorsport action and more. Explore my galleries or get in touch for prints and commissions.</p>
        </div>
    </div>
</section>

<?php 
// Display Homepage Content Widget Area
